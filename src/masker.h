...
#define DEFAULT_LIST_FILE_PREFIX (char *)"kmer_lists/homo_sapiens"
...
formula_parameters *create_formula_parameters_from_list_file_prefix (const char *list_name_prefix, unsigned int word_length, pr_append_str *parse_err);
formula_parameters **create_default_formula_parameters (const char *list_name_prefix, pr_append_str *parse_err);
